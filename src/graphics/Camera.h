...
private:
  ...
  float moveAccelerationSide, moveAccelerationVertical, moveAccelerationFront;
  float moveAccelerationSensitivity;
  bool accumulateMoveSide = false, accumulateMoveFront = false, accumulateMoveVertical = false;
