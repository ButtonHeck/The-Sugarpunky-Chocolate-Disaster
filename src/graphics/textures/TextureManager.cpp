    ...
    loader(loader)
{
  ...
  textures[TEX_HEMISPHERE_DIFFUSE] = loader.loadTexture("hemisphereDiffuse.png", TEX_HEMISPHERE_DIFFUSE, GL_CLAMP_TO_EDGE, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR_MIPMAP_LINEAR, false);
  textures[TEX_THE_SKY] = loader.loadTexture("sky.png", TEX_THE_SKY, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR_MIPMAP_LINEAR, false);
