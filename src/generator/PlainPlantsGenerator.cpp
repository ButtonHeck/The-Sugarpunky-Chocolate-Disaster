#include "PlainPlantsGenerator.h"

PlainPlantsGenerator::PlainPlantsGenerator()
  :
    PlantGenerator()
{
...
void PlainPlantsGenerator::setup(std::vector<std::vector<float> > &baseMap, std::vector<std::vector<float> > &hillMap)
{
  setupModelChunks();
  setupMatrices(baseMap, hillMap);
}

void PlainPlantsGenerator::setupMatrices(std::vector<std::vector<float> > &baseMap, std::vector<std::vector<float> > &hillMap)
{
