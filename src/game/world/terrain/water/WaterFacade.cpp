...
void WaterFacade::draw(glm::vec3 &lightDir, glm::mat4& projectionView, glm::vec3 &viewPosition, Frustum &viewFrustum, bool useCulling, bool useDebugRender)
{
  shaders.update(lightDir, useCulling, projectionView, viewPosition, viewFrustum);
