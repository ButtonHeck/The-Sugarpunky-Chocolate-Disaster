...
public:
	...
	void updateCursorMappingCoordinates( const map2D_f & landMap,
...
private:
	...
	static void cursorMoveCallback( GLFWwindow *,
									double x,
									double y );
	static void scrollCallback( GLFWwindow *,
								double,
								double y );
	static void cursorClickCallback( GLFWwindow *,
									 int,
									 int,
									 int );
