...
# default = 2.0
anisotropy<f>=2.0
# applied only if DOF is enabled, default = 0.08
dof_distance_linear<f>=0.08
# default = 4096
depthmap_texture_width<i>=4096
# default = 4096
depthmap_texture_height<i>=4096
# default = 600
frame_water_reflection_width<i>=600
# default = 450
frame_water_reflection_height<i>=450
# default = 1200
frame_water_refraction_width<i>=1200
# default = 900
frame_water_refraction_height<i>=900
# default = 20.0
