...
constexpr unsigned int LOADING_DISTANCE_CHUNKS = 2;
...
constexpr unsigned int LOADING_DISTANCE_CHUNKS_LOWPOLY = 8;
constexpr unsigned int LOADING_DISTANCE_UNITS_LOWPOLY = CHUNK_SIZE * LOADING_DISTANCE_CHUNKS_LOWPOLY;
constexpr unsigned int LOADING_DISTANCE_UNITS_LOWPOLY_SQUARE = LOADING_DISTANCE_UNITS_LOWPOLY * LOADING_DISTANCE_UNITS_LOWPOLY;
constexpr unsigned int LOADING_DISTANCE_CHUNKS_SHADOW = 4;
constexpr unsigned int LOADING_DISTANCE_UNITS_SHADOW = CHUNK_SIZE * LOADING_DISTANCE_CHUNKS_SHADOW;
constexpr unsigned int LOADING_DISTANCE_UNITS_SHADOW_SQUARE = LOADING_DISTANCE_UNITS_SHADOW * LOADING_DISTANCE_UNITS_SHADOW;
...
const float SHADOW_DISTANCE_LAYER1 = 20.0f;
const float SHADOW_DISTANCE_LAYER2 = 60.0f;
const unsigned int NUM_SHADOW_LAYERS = 3;
